...
ALTER TABLE "BrandProfile" 
  ...
  ALTER COLUMN "typography" TYPE jsonb USING typography::jsonb,
  ALTER COLUMN "logoPath" TYPE jsonb USING logoPath::jsonb,
  ALTER COLUMN "patterns" TYPE jsonb USING patterns::jsonb;
